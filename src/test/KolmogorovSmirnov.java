 ...
 *
 * Kolmogorov-Smirnov implementation from McCallum's PhD thesis (notes starting
 * '//' are his.) Converted from C to Java.
 *
...
class KolmogorovSmirnov {
	...
	/**
	 * PAC: add this method to deal with an array of Doubles (instead of an array of
	 * floats)
	 **/
	/**
